...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-4 z-40 h-14 w-14 rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all flex items-center justify-center"
