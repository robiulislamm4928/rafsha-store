        ...
        <div className="container px-4 py-10 md:py-16 space-y-12 md:space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="p-6 md:p-8 bg-secondary/40 rounded-xl border border-border">
              ...
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                আমরা সারাদেশে সেরা মূল্যে সর্বোত্তম মানের পণ্য সরবরাহ করতে প্রতিশ্রুতিবদ্ধ। নিরাপদ পেমেন্ট এবং চমৎকার কাস্টমার সাপোর্ট — এই স্তম্ভগুলোর উপর দাঁড়িয়ে আমরা বাংলাদেশের অন্যতম বিশ্বস্ত অনলাইন শপ হিসেবে নিজেদের প্রতিষ্ঠিত করতে চাই।
              </p>
            </div>
          </div>
